...
<html>
	...
	<body>	
		...
		<div id="main">
						...
						$sql = "SELECT * FROM APPOINTMENT WHERE doctor='Robert R Morrison'";
	              ...
	              <br /><br /><center>  <h2 style="background-color:lightgreen;">Welcome Robert R Morrison your upcoming appointments</h2> <br /><br />
					<table>
	        <?php
