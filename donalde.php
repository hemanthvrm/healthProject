...
<html>
	...
	<body>	
		...
		<div id="main">
						...
						$sql = "SELECT * FROM APPOINTMENT WHERE doctor='Donald E Cole'";
	              ...
	              <br /><br /><center>  <h2 style="background-color:lightgreen;">Welcome Donald E Cole your upcoming appointments</h2> <br /><br />
					<table>
	        <?php
