...
<html>
	...
	<body>	
		...
		<div id="main">
						...
						$sql = "SELECT * FROM APPOINTMENT WHERE doctor='Barry D Rutherford'";
	              ...
	              <br /><br /><center>  <h2 style="background-color:lightgreen;">Welcome Barry D Rutherford your upcoming appointments</h2> <br /><br />
					<table>
	        <?php
